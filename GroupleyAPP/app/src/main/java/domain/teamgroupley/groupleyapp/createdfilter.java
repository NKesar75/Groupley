...
public class createdfilter extends AppCompatActivity {

    private static final String TAG = "createdfilter";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_createdfilter);
        if (getSupportActionBar() != null) {
            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
            getSupportActionBar().setDisplayShowHomeEnabled(true);
        }

        Sortby = (Spinner) findViewById(R.id.SortbySpinnercreate);
        ArrayAdapter<String> Sort = new ArrayAdapter<String>(domain.teamgroupley.groupleyapp.createdfilter.this,
        ...
        Cata = (Spinner) findViewById(R.id.Speficspinercreate);

        Fil = (Button) findViewById(R.id.FilterSavecreate);

        Aevents = (RadioButton) findViewById(R.id.ALLEVENTSBTNcreate);
        Yevents = (RadioButton) findViewById(R.id.YOUREVEENTSBUTTONcreate);
        Sevents = (RadioButton) findViewById(R.id.SPEFICEVENTSBTNcreate);
        ...
        Fil.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(domain.teamgroupley.groupleyapp.createdfilter.this,CreatedEventList.class));
