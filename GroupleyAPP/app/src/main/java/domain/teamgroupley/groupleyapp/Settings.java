        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (interstcounter >= 10) {
                    ...
                    Intent changepage = new Intent(Settings.this, Home.class);
                    startActivity(changepage);
                    Toast.makeText(Settings.this, "Interest Saved.",
                            Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(Settings.this, "Select Atleast 10 Interests", Toast.LENGTH_SHORT).show();
                }
