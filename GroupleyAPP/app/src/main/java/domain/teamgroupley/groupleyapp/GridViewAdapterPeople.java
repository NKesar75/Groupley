...
public class GridViewAdapterPeople extends ArrayAdapter<People>
{
    private Activity context;
    private int resource;
    private List<People> listImage;

    public GridViewAdapterPeople(Context context,int resource, List<People> objects)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if(null == v)
        {
            ...
            v = inflater.inflate(R.layout.grid_item_people,null);
        }
