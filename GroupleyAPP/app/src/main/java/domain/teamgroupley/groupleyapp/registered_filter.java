...
public class registered_filter extends AppCompatActivity {

    private static final String TAG = "registered_filter";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registered_filter);
        if (getSupportActionBar() != null) {
            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
            getSupportActionBar().setDisplayShowHomeEnabled(true);
        }

        Sortby = (Spinner) findViewById(R.id.SortbySpinnerreg);
        ArrayAdapter<String> Sort = new ArrayAdapter<String>(domain.teamgroupley.groupleyapp.registered_filter.this,
        ...
        Cata = (Spinner) findViewById(R.id.Speficspinerreg);

        Fil = (Button) findViewById(R.id.FilterSavereg);

        Aevents = (RadioButton) findViewById(R.id.ALLEVENTSBTNreg);
        Yevents = (RadioButton) findViewById(R.id.YOUREVEENTSBUTTONreg);
        Sevents = (RadioButton) findViewById(R.id.SPEFICEVENTSBTNreg);

        Aevents.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Cata.setVisibility(View.GONE);
            }
        });

        Yevents.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Cata.setVisibility(View.GONE);
            }
        ...
        Sevents.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        Fil.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(domain.teamgroupley.groupleyapp.registered_filter.this,Registered_Events.class));
