    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                profileImage = dataSnapshot.child(userID).child("UserInfo").child("Image").child("url").getValue(String.class).toString();
                                    ...
                                    if (!stateget.equals("")){
                                        if (!zipget.equals("")){
                                            if (!countryget.equals("")){
                                                if (!MAxppl.equals("")) if (!Die.equals("")) {
                                                    ...
                                                    final ProgressDialog progressDialog = new ProgressDialog(Create_Event.this);
                                                    ...
                                                    Thread t = new Thread(new Runnable() {
                                                        ...
                                                        public void run()
                                                        {
                                                         int progress = 0;
                                                            ...
                                                            Create_Event.this.runOnUiThread(new Runnable() {
                                                                @Override
                                                                public void run() {
